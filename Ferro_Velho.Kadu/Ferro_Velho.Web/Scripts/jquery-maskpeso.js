/*
 *  jquery-maskpeso - v3.0.2
 *  jQuery plugin to mask data entry in the input text in the form of peso (currency)
...
! function($) {
    ...
    var a = {
        destroy: function() {
            return $(this).unbind(".maskPeso"), $.browser.msie && (this.onpaste = null), this
        },
        mask: function(a) {
        ...
        init: function(a) {
            return a = $.extend({
                ...
                var r, s = $(this);
                a = $.extend(a, s.data()), s.unbind(".maskPeso"), s.bind("keypress.maskPeso", k), s.bind("keydown.maskPeso", l), s.bind("blur.maskPeso", p), s.bind("focus.maskPeso", m), s.bind("click.maskPeso", q), s.bind("cut.maskPeso", n), s.bind("paste.maskPeso", n), s.bind("mask.maskPeso", h)
            })
        }
    };
    $.fn.maskPeso = function(b) {
        return a[b] ? a[b].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof b && b ? ($.error("Method " + b + " does not exist on jQuery.maskPeso"), void 0) : a.init.apply(this, arguments)
    }
